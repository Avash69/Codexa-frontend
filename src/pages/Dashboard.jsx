            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <motion.p
                  ...
                  className="mb-8 text-xl text-slate-300"
                >
                  Codexa connects talented developers with companies
          ...
          >
            ...
            >
              <p className="mb-4 text-slate-300">
                "I quickly discovered tasks that matched my skills. 
                The platform is intuitive to use, and payments are prompt and dependable."
              </p>
              <div className="flex items-center">
                <div>
            ...
            >
              <p className="mb-4 text-slate-300">
                "Codexa simplified the process of finding reliable developers for our startup."
              </p>
              <div className="flex items-center">
                <div>
                  <div className="font-semibold text-indigo-400">
